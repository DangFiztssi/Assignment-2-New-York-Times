...
- Difficulty to understand Interceptor definition.
- I was confused JSONObject and JsonObject.
- I want to implement feature hide ActionBar when scrolling content in Activity, Webview,... but not yet :(
- I think performance of this app not good and want to improve it for better.
